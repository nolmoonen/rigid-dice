...
const TextureManager::TextureResource TextureManager::TEXTURE_RESOURCES[] = {
        {
                .id=TEXTURE_GRASS, .channels=4,
                .text=grass_png, .len=&grass_png_len
        },
        {
        ...
        {
                .id=TEXTURE_DICE, .channels=4,
                .text=dice_png, .len=&dice_png_len
        },
        {
                .id=TEXTURE_SKYBOX, .channels=4,
                .text=skybox_png, .len=&skybox_png_len
        },
        {
                .id=TEXTURE_WOOD, .channels=3,
                .text=wood_png, .len=&wood_png_len
        },
};
